...
public class BuildingServiceimpl implements Buildingservice{
	...
	public List<BuildingDTO> findAll(Map<String, Object> param, List<String> type) {
		...
		BuildingSearchBuilder builderBuildingSearchBuilder = buildingSearchBuilderConverter.toBuildingSearchBuilder( param,  type);
	List<BuildingEntity> bd = buildingrepository.findAll(builderBuildingSearchBuilder);
